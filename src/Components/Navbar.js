...
function Navbar() {
    return (
        <div className="Bg-color fixed z-10 text-white px-3 mx-2 flex Width  h-17 justify-between items-center rounded-xl my-2">
            <div className="flex ">                
            ...
            <div className="">                
                <a href="signu" className="poppins-regular bg-gray-500 rounded-lg px-3 py-2 text-white no-underline">Register</a>
